...
export const ActionBarOverflow = ({
	...
	return (
		...
		<li class="made-c-action-bar__item made-c-action-bar__item">
			<a href="" role="button">
				Dropdown 1
			<svg
				width="8"
			...
			>
				...
				{show == "Dropdown 1" && (
					<path d="M12 0L0 9l1.069 1.425L12 2.226l10.931 8.199L24 9z" fill="currentColor" fill-rule="evenodd"/>
				)}	
				{show != "Dropdown 1" && (	
					<path d="M12 10.425l-12-9L1.069 0 12 8.198 22.931 0 24 1.425z" fill="currentColor" fill-rule="evenodd" />
				)}	
			</svg>
			</a>
			{show == "Dropdown 1" && (
