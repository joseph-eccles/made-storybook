			...
			<div class="made-l-grid">
				<div class="made-l-grid__row made-u-flex-space-between">
					<div class="made-l-grid__item made-l-grid__item--md-6">
						<img class="made-u-margin-top-10-x" src="https://cdn.jsdelivr.net/gh/joseph-eccles/made-storybook@main/storybook/stories/assets/images/logo-small.svg" alt="Mastercard logo" width="50" height="30" />
