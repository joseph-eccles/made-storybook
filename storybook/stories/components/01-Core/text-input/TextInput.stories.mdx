...
<div class="made-c-form__element">
  ...
  <div class="made-c-text-input__wrapper">
    <input type="text" id="exampleFormElementInput2" name="disabled-state" class="made-c-text-input" placeholder="Placeholder text" aria-disabled="true" disabled></input>
  </div>
  <div class="made-c-form__hint">Helper text</div>
</div>`,
        },
...
<div class="made-c-form__element">
  ...
  <div class="made-c-text-input__wrapper">
    ...
    <input type="text" id="error-state" name="error" class="made-c-text-input made-c-text-input--error" placeholder="Placeholder text"></input>
  </div>
...
<div class="made-c-form__element">
  ...
  <div class="made-c-text-input__wrapper">
    ...
    <input type="text" id="success-state" name="success" class="made-c-text-input made-c-text-input--success" placeholder="Placeholder text"></input>
  </div>
